...
void loop() {
  ...
  switch (stage) {
    case 0: distance = 400; break;
    case 1: distance = 350; break;
    case 2: distance = 300; break;
    case 3: distance = 250; break;
    case 4: distance = 200; break;
    case 5: distance = 150; break;
    case 6: distance = 100; break;
    case 7: distance = 80; break;
    case 8: distance = 60; break;
    case 9: distance = 40; break;
    case 10: distance = 20; break;
    case 11: distance = 7; break;
    case 12: distance = 4; break;
    default: distance = 3; break;
  }
  ...
  if (millis() - lastPrint > 1000) {
    ...
    if (distance > 70)
      animation = "RAINBOW SAFE";
    else if (distance > 50)
      animation = "GREEN-YELLOW";
    else if (distance > 30)
      animation = "YELLOW-ORANGE";
    else if (distance > 10)
